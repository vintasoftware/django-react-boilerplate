...
- Run the following:
  ```bash
  cd .. && django-admin startproject theprojectname --extension py,yml,json --name Procfile,README.md,.env.example,Dockerfile,Makefile --template=django-react-boilerplate/boilerplate.zip
  ```
