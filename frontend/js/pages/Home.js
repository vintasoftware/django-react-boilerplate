  ...
  return (
    <>
      <div id="django-background">
        If you're seeing the green Django logo on a white background and this
        text color is #092e20, frontend static files serving is working
      </div>
      <div id="django-logo-wrapper">
        <div>Below this text, you should see an img tag with the white Django logo on a green background</div>
        <img src={DjangoImgSrc} alt="Django Negative Logo" />
      </div>
